...
\pic at (0\horizdist,\vertdist) {charactercard={pirate-6}{Once per game, you may become the captain and reallocate shares to all characters before voting.}{2}{black}};
...
\pic at (\horizdist,\vertdist) {charactercard={pirate-3}{Once per game, you may declare a mutiny by all characters except the captain before voting.}{3}{black}};
...
\pic at (\horizdist,0\vertdist) {charactercard={pirate-2}{Once per game, you may claim your allocated share regardless of how you voted.}{6}{black}};

\pic at (-\horizdist,-\vertdist) {lootcard={pirate-ship-small}{\captaintext}{black}};
\pic at (0\horizdist,-\vertdist) {charactercard={pirate-7b}{Once per game, you may participate in a mutiny\\regardless of how you voted.}{7}{black}};
...
\pic at (\horizdist,-\vertdist) {lootcard={parrot-2-small}{\parrottext}{black}};
\end{tikzpicture}
\end{document}